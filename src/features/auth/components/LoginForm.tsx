...
export function LoginForm() {
  ...
  return (
    <Card className="w-full max-w-md mx-auto shadow-lg border-border/50 bg-card">
      ...
      <CardContent className="space-y-4 pt-4">
        <Button
          variant="outline"
          className="w-full h-12 shadow-sm relative text-base font-medium"
        ...
        <p className="text-xs text-center text-muted-foreground pt-2">{t('login.safe')}</p>
      </CardContent>
    </Card>
  )
}
